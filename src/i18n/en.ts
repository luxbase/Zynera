export default {
  ...
  hero: {
    h1: 'Transform Any Visual Into Its Best Version.',
    p: 'From property photos to websites and marketing assets — premium AI at your brand\'s service.',
    cta: 'Get started →',
  },
  comparison: {
  ...
  modal: {
    ...
    steps: [
      ...
      },
      {
        ...
        styles: ['Mediterranean', 'Manhattan', 'Minimalist'],
        credConsent: 'I understand that Qualis Studio will use my credentials only to edit this listing and will delete them upon completion.',
