export default {
  ...
  hero: {
    h1: 'Transformá cualquier visual en su mejor versión.',
    p: 'De fotos de propiedades a sitios web y activos de marketing — IA premium al servicio de tu marca.',
    cta: 'Solicitar →',
  },
  comparison: {
    ...
    steps: [
      {
        ...
        modes: [
          { value: 'Handoff', label: 'Básico', desc: 'Nos enviás las fotos, te devolvemos el staging' },
          { value: 'Done-for-you', label: 'Empresarial', desc: 'Nos das acceso al portal y lo editamos por vos · No guardamos credenciales' },
        ],
      },
      {
      ...
      },
      {
        ...
        styles: ['Mediterráneo', 'Manhattan', 'Minimalista'],
        credConsent: 'Entiendo que Qualis Studio usará mis credenciales solo para editar esta publicación y las eliminará al finalizar.',
